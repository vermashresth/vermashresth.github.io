...
---
I am a second-year PhD student at Harvard University advised by [Prof. Milind Tambe](https://teamcore.seas.harvard.edu/tambe). I'm interested in <span style="color: #f3c15f; font-weight: bold;">reinforcement learning and multi-agent systems for planning and optimization with applications in public health. </span>. My current work focuses on 
<span style="color: #f3c15f; font-weight: bold;">
- Fair and robust algorithms for sequential resource allocation in uncertain environments.
...
- Transparency and alignment in LLMs for planning tasks, augmenting experts in resource-constrained settings.
<\span>
